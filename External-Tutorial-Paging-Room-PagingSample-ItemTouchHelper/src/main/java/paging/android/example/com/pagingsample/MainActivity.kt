...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        cheeseRV.adapter = adapter

        // Subscribe the adapter to the ViewModel, so the items in the adapter are refreshed
        // when the list changes
        viewModel.allCheeses.observe(this, Observer{

            println("🔥 MainActivity observe() PadeList size: ${it.size}")
    ...
    private fun initSwipeToDelete() {
        ...
        ItemTouchHelper(object : ItemTouchHelper.Callback() {
            ...
            override fun getMovementFlags(recyclerView: RecyclerView,
                    ...
                    // Flags determine which direction a move can happen
                    makeMovementFlags(ItemTouchHelper.DOWN or ItemTouchHelper.UP,
            ...
            override fun onSelectedChanged(viewHolder: RecyclerView.ViewHolder?, actionState: Int) {
                ...
                Toast.makeText(this@MainActivity, "onSelectedChanged(): $viewHolder",Toast.LENGTH_SHORT).show()
            }
        }).attachToRecyclerView(cheeseRV)
    }
